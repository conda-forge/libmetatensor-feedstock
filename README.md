...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libmetatensor-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libmetatensor-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libmetatensor
# for installing globally
pixi global install libmetatensor
```
...
It is possible to list all of the versions of `libmetatensor` available on your platform:
...
```
pixi search libmetatensor --channel conda-forge
```
